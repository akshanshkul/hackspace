...
$doctorObj = new App\doctor\fetchData;
$deptId = 1;
$doctorData = $doctorObj->fetchByDept($deptId);
$patientDeatils = new App\patient\getDetails;
?>
<!--  Header End -->
<!DOCTYPE html>
<html lang="en">
    ...
    <div class="card">
      <div class="card-body">
        ...
        <table class="table table-bordered">
          ...
          <tbody>
            <?php $i = 1;
            while ($data = mysqli_fetch_assoc($doctorData)) {
              $patientData = mysqli_fetch_assoc($patientDeatils->fetchByAdhaar($data['adhaar_no']));
              $i = 1;
              ?>
              <tr>
                <td>1</td>
                ...
                <td>
                  ...
                  <button class="btn btn-primary"
                    onclick="openPopup('<?= $i ?>',' <?= $patientData['name'] ?>', '<?= $data['date'] ?>')">Select</button>
                </td>
              </tr>
              <?php
              $i++;
